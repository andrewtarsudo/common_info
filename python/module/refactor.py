...
# define the format
def get_format(rect_width: int, rect_height: int, orient: str) -> tuple:
    # define the most common formats
    page = (rect_width, rect_height)
...
def get_rectangle_extr(format_file: str, orient: str) -> tuple:
    # format A4, the common sheet
    if format_file == 'A4' and orient == 'portrait':
        return UP_LEFT_X_A4, UP_LEFT_Y_A4, DOWN_RIGHT_X_A4, DOWN_RIGHT_Y_A4
    # format A3, two common sheets
    elif format_file == 'A3' and orient == 'landscape':
